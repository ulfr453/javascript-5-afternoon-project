...
let employeeOne = new Employee('cam', 'buford', 'cambuf@gmail.com', 30)
...
let managerOne = new Manager('cam', 'buford', 'cambuf@gmail.com', 30)
...
class Machine {
  constructor(widgets_made_count= 0, wear_and_tear_count= 0,
    needs_reboot= false) {
